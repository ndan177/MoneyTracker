...
import com.example.nohai.moneytracker.CreateFileActivity;
import com.example.nohai.moneytracker.R;
import com.example.nohai.moneytracker.RetrieveContentsActivity;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.upload:
                ...
                break;
            case R.id.download:
                Intent intent2 = new Intent(getBaseContext(), RetrieveContentsActivity.class);
