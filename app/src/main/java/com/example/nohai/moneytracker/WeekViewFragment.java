...
public class WeekViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // in the foreground.
        expenseList= PageTwo.findViewById(R.id.expenseList);
        ...
        incomeList= PageTwo.findViewById(R.id.incomeList);
    ...
    void openExpenseList()
    {
        ...
        expenseListIntent.putExtra("type",2);
    ...
    void openIncomeList()
    {
        ...
        incomeListIntent.putExtra("type",2);
